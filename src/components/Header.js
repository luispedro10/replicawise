...
export default class Header extends React.Component {
  ...
  <nav className="tw-public-nav__menu tw-public-nav__menu-right">
    <ul>
      ...
      <li>
        <a href="#">
          <img src="https://wise.com/web-art/assets/flags/gt.svg" alt="GT Flag" width="32" height="24" />
          EN
        </a>
      </li>
      <li><a href="#">Log in</a></li>
      <li><a href="/" className="btn btn-accent btn-sm text-ellipsis btn-active">Register</a></li>
    </ul>
  </nav>
</div>
      </header>
